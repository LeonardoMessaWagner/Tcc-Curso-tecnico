               ...
               <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 ">
                         <div class="section-title wow fadeInUp" data-wow-delay="0.1s">
                              <h2  style="color: white; margin-top: 5%;">Lista de unidades Protoss</h2>
                         </div>
                    </div>
          <div class="container">
           <?php include('conect.php');
			$query = "SELECT * FROM protoss ORDER BY nomep ASC";
               $result = mysqli_query($conexao,$query);
               $cont = 0;
			while ($register = mysqli_fetch_array($result)) {
                    $cont= $cont +1;
                   $contador[$cont] = $register['nomep'];
			$fotop = $register['fotop'];
			$nomep = $register['nomep'];
			?> 
                    <div class="col-lg-4">
                         <img style=width:300px;height:200px; src="<?php echo "$fotop";?>">
                         <p ><br><form method="POST" action="protoss_exbidor.php"> <button name="exibidor" style="color:black;border-radius:5px;" value="<?php echo $contador[$cont];?>" class="section-btn" > <?php echo $nomep;?></button>
                         </form></p></div>
