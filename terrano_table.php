               ...
               <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 ">
                         <div class="section-title wow fadeInUp" data-wow-delay="0.1s">
                              <h2  style="color: white; margin-top: 5%;">Lista de unidades Terranas</h2>
                         </div>
                    </div>
          <div class="container">
           <?php include('conect.php');
			$query = "SELECT * FROM terrano ORDER BY nomet ASC";
               $result = mysqli_query($conexao,$query);
               $cont=0;
			while ($register = mysqli_fetch_array($result)) {
                    $cont= $cont +1;
                   $contador[$cont] = $register['nomet'];
			$fotot = $register['fotot'];
			$nomet = $register['nomet'];
			?> 
                    <div class="col-lg-4">
                         <img style=width:300px;height:200px; src="<?php echo "$fotot";?>">
                         <p ><br><form method="POST" action="terrano_exbidor.php"> <button name="exibidor" style="color:black;border-radius:5px;" value="<?php echo $contador[$cont];?>" class="section-btn" > <?php echo $nomet;?></button>
                         </form></p></div>
